...
const inclusions = [
  ...
  { icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4', label: 'Hébergement 4 étoiles' },
  { icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', label: 'Petit-déjeuner inclus' },
...
const itinerary = [
  { day: 'Jour 1', title: 'Arrivée & Installation', description: 'Accueil à l\'aéroport, transfert à l\'hôtel. Installation et temps libre pour découvrir les environs.' },
  { day: 'Jour 2', title: 'Découverte guidée', description: 'Visite guidée des principaux sites touristiques avec un guide local francophone.' },
  { day: 'Jour 3', title: 'Activités & Excursions', description: 'Journée d\'activités selon la destination : randonnée, plongée, visite culturelle...' },
  { day: 'Jour 4', title: 'Temps libre & Shopping', description: 'Matinée libre pour le shopping ou la détente. Préparation des valises.' },
  { day: 'Jour 5', title: 'Dernières découvertes', description: 'Dernières visites et photos souvenirs. Transfert vers l\'aéroport.' },
]
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex gap-1 mb-8 border-b border-gray-200">
                {[
                  ...
                  { key: 'inclusions', label: 'Inclus' },
                ].map((tab) => (
                  <button
                    key={tab.key}
                    onClick={() => setActiveTab(tab.key)}
                    className={`px-5 py-3 font-medium text-sm transition-all border-b-2 -mb-px ${
                      activeTab === tab.key
              ...
              {activeTab === 'overview' && (
                <div className="space-y-6">
                  <div>
                    <h2 className="font-display font-bold text-2xl text-gray-900 mb-4">À propos de ce voyage</h2>
                    <p className="text-gray-600 leading-relaxed text-lg">{destination.description}</p>
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      { label: 'Durée', value: `${destination.duration} jours`, icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
              ...
              {activeTab === 'inclusions' && (
                <div>
                  ...
                  <div className="mt-8 p-6 bg-amber-50 rounded-xl border border-amber-100">
                    <h3 className="font-display font-semibold text-gray-900 mb-2">Non inclus</h3>
              ...
              <div className="card p-6 sticky top-24">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex items-center gap-3 text-sm text-gray-600">
                    ...
                    <span>{destination.rating} / 5 - Excellent</span>
                  </div>
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 relative">
            ...
            {bookingSuccess ? (
              ...
              <>
                <h3 className="font-display font-bold text-xl text-gray-900 mb-1">Réserver ce voyage</h3>
                ...
                <form onSubmit={handleBooking} className="space-y-4">
                  ...
                  <div className="pt-2 border-t border-gray-100">
                    ...
                    <div className="flex justify-between text-lg font-bold">
                      <span>Total</span>
                      <span className="text-primary-600">{destination.price}€</span>
                    </div>
                  </div>
